...
main()
{
  ...
  printf( "Nombre de obj1_t  = %lu\n" , obj1_cpt ) ;/*modification ajouter*/
  printf( "Nombre de obj1s_t  = %lu\n" , obj1s_cpt ) ;/*modification ajouter*/
  printf( "Nombre de obj2_t  = %lu\n" , obj2_cpt ) ;/*modification ajouter*/
  printf( "Nombre de obj2s_t  = %lu\n" , obj2s_cpt ) ;/*modification ajouter*/
...
valgrind --leak-check=full  ./test_obj2s
